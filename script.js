const HOME_POSITION = new THREE.Vector3(0, 0, 25);
function createOrbScene(container, { interactive = true } = {}) {
  ...
  const bloom = new THREE.UnrealBloomPass(new THREE.Vector2(width, height), 0.65, 0.28, 0.38);
...
/* ==========================================================================
   MADHAS — Landing Page JavaScript (v3 — SIGNAL orb integration)

   CONTENTS
   1.  Three.js Hero Scene (imported orbScene)
   2.  Mobile Nav Toggle
   3.  Smooth Scroll
   4.  Scroll Reveal
   5.  Typing Ticker
